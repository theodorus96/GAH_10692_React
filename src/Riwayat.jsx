...
export function Riwayat() {
  ...
  const getRiwayat = (id_dataUser) => {
    id_dataUser = localStorage.getItem("id_dataUser");
    instance
      .get(`/reservasi/riwayat/${id_dataUser}`, {
        headers: {
  ...
  const filteredRiwayat = riwayatData.filter((riwayat) =>
  ...
  return (
    <div>
      ...
      <div className="flex flex-col justify-center items-center h-screen bg-login-bg">
        <Card className="h-[600px] w-[1000px] items-center">
